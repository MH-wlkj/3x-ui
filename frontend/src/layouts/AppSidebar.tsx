...
export default function AppSidebar() {
  ...
  const navItems = useMemo(() => tabs.filter((tab) => tab.icon !== 'logout' && tab.key !== '/settings' && tab.key !== '/client-generator'), [tabs]);
  const utilItems = useMemo(() => tabs.filter((tab) => tab.icon === 'logout' || tab.key === '/settings' || tab.key === '/client-generator'), [tabs]);
    ...
    <div className="ant-sidebar">
      ...
      >
        <div className={`sider-brand${collapsed ? ' sider-brand-collapsed' : ''}`}>
          <div className="brand-block">
            <span className="brand-text">{collapsed ? 'MH' : 'MH网络科技面板'}</span>
          </div>
          {!collapsed && (
      ...
      >
        <div className="drawer-header">
          <div className="brand-block">
            <span className="drawer-brand">MH网络科技面板</span>
          </div>
